function initGoogle() {
    dojo.declare("GoogleMapLayer", esri.layers.TiledMapServiceLayer, { // create WMTSLayer by extending esri.layers.TiledMapServiceLayer  
        ...
        getTileUrl: function (level, row, col) {
            ...
            return "http://mt" + (col % 4) + ".google.cn/vt/lyrs=s@146&hl=zh-CN&gl=cn&src=app&x=" + col + "&y=" + row + "&z=" + level + "&s=Gali";
            //return "http://mt3.google.cn/vt/lyrs=s@146&amp;hl=zh-CN&amp;gl=CN&amp;src=app&amp;s=G&x=" + col + "&y=" + row + "&z=" + level;
        }
    });
